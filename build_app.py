...
TOP10 = [
 dict(id="wakad_imax", v="INOX Megaplex, Phoenix Mall of the Millennium", s="IMAX", audi="Audi 7", area="Wakad",
  ...
  price=dict(cl=390,cp=420,pr=540,pp=620,rc=790), psrc="District",
 ...
 dict(id="dolby", v="City Pride Kharadi", s="Audi 6 — Dolby Cinema", area="Kharadi",
  ...
  price=dict(cl=380,xl=420,pr=450,sf=650), psrc="approx",
 ...
 dict(id="westend_imax", v="Cinepolis Nexus Westend Mall", s="IMAX", area="Aundh",
  tech="IMAX Dual Xenon 2K · 1.90:1 — oldest IMAX tech in the city", w=55,h=31,conf="exact District seat grid (verified live in browser, Aug 2026)", seats=283,
  lay=[R("A",[[6,"cl"],[2,"g"],[14,"cl"],[8,"g"]]),
       R("B",[[6,"xl"],[2,"g"],[14,"xl"],[8,"g"]]),
       R("C",[[6,"cp"],[2,"g"],[14,"cp"],[8,"g"]]),R("D",[[6,"cp"],[2,"g"],[14,"cp"],[8,"g"]]),
       R("E",[[6,"pr"],[2,"g"],[14,"pr"],[4,"g"],[4,"pr"]]),R("F",[[6,"pr"],[2,"g"],[14,"pr"],[4,"g"],[4,"pr"]]),
       R("G",[[6,"pr"],[2,"g"],[14,"pr"],[4,"g"],[4,"pr"]]),
       R("H",[[6,"xl"],[2,"g"],[14,"xl"],[8,"g"]]),
       R("I",[[6,"p+"],[2,"g"],[14,"p+"],[8,"g"]]),R("J",[[6,"p+"],[2,"g"],[14,"p+"],[8,"g"]]),
       R("K",[[6,"p+"],[2,"g"],[14,"p+"],[8,"g"]]),R("L",[[6,"p+"],[2,"g"],[14,"p+"],[8,"g"]]),
       R("M",[[6,"p+"],[11,"g"],[5,"p+"],[8,"g"]]),
       R("N",[[4,"rc"],[20,"g"],[6,"rc"]]),R("O",[[4,"rc"],[20,"g"],[6,"rc"]])],
  price=dict(cl=380,cp=410,xl=430,pr=470,**{'p+':520},rc=950), psrc="approx",
 ...
 dict(id="pxl", v="PVR Grand Highstreet, Hinjawadi", s="P[XL]", area="Hinjawadi",
  ...
  price=dict(cl=410,pr=430,**{'p+':460},el=480,rc=650), psrc="District",
 ...
 dict(id="kothrud1", v="City Pride Kothrud", s="Audi 1", area="Kothrud",
  ...
  price=dict(sv=180,gd=350), psrc="approx",
 ...
 dict(id="esq5", v="E-Square University Road", s="Screen 5", area="University Rd",
  ...
  price=dict(sv=150,gd=280), psrc="approx",
 ...
 dict(id="icon", v="PVR ICON, The Pavillion Mall", s="Audi 04", audi="Audi 04", area="SB Road",
  ...
  lay=[R("A",[[1,"g"],[5,"cl"],[1,"g"],[9,"cl"]]),R("B",[[1,"g"],[5,"cl"],[1,"g"],[9,"cl"]]),
       ...
       R("P",[[3,"g"],[8,"rc"],[5,"g"]])],
  price=dict(cl=320,pr=400,**{'p+':420},rc=750), psrc="District",
 ...
 dict(id="ice", v="PVR Director's Cut, KOPA Mall", s="ICE Theatre", area="Koregaon Park",
  tech="4K Laser · Dolby Atmos · LED side panels · scope screen", w=33,h=14,conf="exact District seat grid (verified live in browser, Aug 2026)", seats=184,
  lay=[R(c,[[3,"g"],[12,"pr"],[1,"g"],[4,"pr"],[3,"g"]]) for c in "ABCDEFG"]+
      [R("H",[[3,"g"],[12,"p+"],[1,"g"],[4,"p+"],[3,"g"]]),R("J",[[3,"g"],[12,"p+"],[1,"g"],[4,"p+"],[3,"g"]]),
       R("K",[[1,"g"],[14,"p+"],[1,"g"],[4,"p+"],[3,"g"]]),R("L",[[11,"p+"],[1,"g"],[11,"p+"]])],
  price=dict(pr=570,**{'p+':660}), psrc="District",
 ...
 dict(id="insignia", v="INOX Megaplex, Phoenix MoM", s="Insignia", area="Wakad",
  tech="4K Laser · Dolby Atmos · every seat a Royal Recliner", w=30,h=16,conf="exact District seat grid (verified live in browser, Aug 2026)", seats=49,
  lay=[R("E",[[3,"g"],[9,"ry"],[1,"g"]]),R("D",[[3,"g"],[9,"ry"],[1,"g"]]),R("C",[[3,"g"],[9,"ry"],[1,"g"]]),
       R("B",[[1,"g"],[11,"ry"],[1,"g"]]),R("A",[[2,"g"],[11,"ry"]])],
  price=dict(ry=730), psrc="District",
